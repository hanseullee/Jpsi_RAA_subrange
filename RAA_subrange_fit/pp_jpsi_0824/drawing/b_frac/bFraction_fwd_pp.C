...
void bFraction_fwd_pp()
{
  ...
  double val_pp_old[n_old] = {0.15185, 0.21544, 0.28734, 0.39389};
  double stat_pp_old[n_old] = {0.00220, 0.00190, 0.00218, 0.00201};
  ...
  double val_oo_y16to24[NooY16to24] = {0.15185, 0.21544, 0.28734, 0.39389};
  double stat_oo_y16to24[NooY16to24] = {0.00220, 0.00190, 0.00218, 0.00201};
  ...
  gSyspp_old->GetXaxis()->SetLimits(0, 40);
  ...
  c1->SaveAs(outputPath("bFrac_ppRun2_fwd.pdf"));
}
