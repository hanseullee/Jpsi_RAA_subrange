...
void bFraction_mid_pp()
{
  ...
  double val_pp_old[n_old] = {0.23413, 0.30460, 0.38581, 0.46464, 0.53122, 0.58616};
  double stat_pp_old[n_old] = {0.00151, 0.00112, 0.00191, 0.00275, 0.00373, 0.00379};
  ...
  double val_oo_y16[NooY16] = {0.23413, 0.30460, 0.38581, 0.46464, 0.53122, 0.58616};
  double stat_oo_y16[NooY16] = {0.00151, 0.00112, 0.00191, 0.00275, 0.00373, 0.00379};
  ...
  leg->AddEntry(gStatOOY16, "pp (|y| < 1.6, c#tau signal fit)", "lp");
  ...
  c1->SaveAs(outputPath("bFrac_ppRun2_mid.pdf"));
}
