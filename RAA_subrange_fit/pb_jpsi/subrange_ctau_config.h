...
inline const std::vector<ManualCtauFitRange> &manual_ctau_fit_ranges()
{
	static const std::vector<ManualCtauFitRange> ranges = {
		// Format:
		//   {ptLow, ptHigh, centLowPct, centHighPct, yLow, yHigh, ctLow, ctHigh, enabled, note}
		{3.5f, 6.5f, 0, 90, 1.6f, 2.4f, -0.50, 3.00, true, ""},
		{6.5f, 9.0f, 0, 90, 1.6f, 2.4f, -0.25, 3.00, true, ""},
		{9.0f, 12.0f, 0, 90, 1.6f, 2.4f, -0.25, 3.00, true, ""},
		{12.0f, 40.0f, 0, 90, 1.6f, 2.4f, -0.25, 2.00, true, ""},
		{3.5f, 40.0f, 0, 10, 1.6f, 2.4f, -0.10, 2.00, true, ""},
		{3.5f, 40.0f, 10, 30, 1.6f, 2.4f, -0.25, 3.00, true, ""},
		{3.5f, 40.0f, 30, 50, 1.6f, 2.4f, -0.25, 3.00, true, ""},
		{3.5f, 40.0f, 50, 90, 1.6f, 2.4f, -0.25, 2.00, true, ""},
		{3.5f, 40.0f, 0, 90, 1.6f, 2.4f, -0.25, 3.00, true, ""},
		{6.5f, 9.0f, 0, 90, 0.0f, 1.6f, -0.25, 3.00, true, ""},
		{9.0f, 12.0f, 0, 90, 0.0f, 1.6f, -0.25, 3.00, true, ""},
		{12.0f, 15.0f, 0, 90, 0.0f, 1.6f, -0.25, 3.00, true, ""},
		{15.0f, 20.0f, 0, 90, 0.0f, 1.6f, -0.10, 2.00, true, ""},
		{20.0f, 25.0f, 0, 90, 0.0f, 1.6f, -0.10, 2.00, true, ""},
		{25.0f, 40.0f, 0, 90, 0.0f, 1.6f, -0.10, 2.00, true, ""},
		{6.5f, 8.5f, 0, 90, 0.0f, 0.6f, -0.1, 3.00, true, ""}, // dhmoon
		{8.5f, 9.5f, 0, 90, 0.0f, 0.6f, -0.1, 3.00, true, ""}, // dhmoon
		{9.5f, 11.0f, 0, 90, 0.0f, 0.6f, -0.1, 3.00, true, ""}, // dhmoon
		{11.0f, 15.0f, 0, 90, 0.0f, 0.6f, -0.1, 3.00, true, ""}, // dhmoon
		{15.0f, 20.0f, 0, 90, 0.0f, 0.6f, -0.1, 3.00, true, ""}, // dhmoon
		{20.0f, 40.0f, 0, 90, 0.0f, 0.6f, -0.1, 3.00, true, ""}, // dhmoon
		{9.0f, 12.0f, 0, 90, 0.0f, 1.6f, -0.25, 3.00, true, ""},
		{6.5f, 40.0f, 0, 10, 0.0f, 1.6f, -0.10, 2.00, true, ""},
		{6.5f, 40.0f, 10, 20, 0.0f, 1.6f, -0.10, 2.00, true, ""},
		{6.5f, 40.0f, 20, 30, 0.0f, 1.6f, -0.10, 2.00, true, ""},
		{6.5f, 40.0f, 30, 40, 0.0f, 1.6f, -0.10, 2.00, true, ""},
		{6.5f, 40.0f, 40, 50, 0.0f, 1.6f, -0.10, 2.00, true, ""},
		{6.5f, 40.0f, 50, 90, 0.0f, 1.6f, -0.10, 2.00, true, ""},
		{6.5f, 40.0f, 0, 90, 0.0f, 1.6f, -0.25, 3.00, true, ""},
	};
	return ranges;
}
...
inline bool same_centrality_bin(const ManualCtauFitRange &range, int cLow, int cHigh)
{
	return range.centLowPct * 2 == cLow && range.centHighPct * 2 == cHigh;
}

inline const ManualCtauFitRange *find_manual_ctau_fit_range(float ptLow, float ptHigh, float yLow, float yHigh, int cLow, int cHigh)
{
	for (const auto &range : manual_ctau_fit_ranges())
	{
		...
		if (same_bin(range.ptLow, ptLow) && same_bin(range.ptHigh, ptHigh) &&
			same_centrality_bin(range, cLow, cHigh) &&
